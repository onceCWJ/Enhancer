...
def main(args):
    ...
    if args.dataset == "CSI300":
        print("CSI300")
        generate_data(args, "data/CSI300/CSI300.npy", "data/CSI300")
        print("Finish!")
    if args.dataset == "CSI500":
        print("CSI500")
        generate_data(args, "data/CSI500/CSI500.npy", "data/CSI500")
        print("Finish!")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--train_rate", type=float, default=(2/3))
    parser.add_argument("--val_rate", type=float, default=(1/6))
    parser.add_argument("--add_time_in_day", type=bool, default=True)
    parser.add_argument("--add_day_in_week", type=bool, default=True)
    parser.add_argument("--dataset",type=str, default="CSI300")
